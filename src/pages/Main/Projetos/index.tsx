      ...
      <Container>
        ...
        <Card>
          ...
          <ImgDiv>
            ...
            <Info>
              <p>
                Aplicação web que mantem o controle das Normas Regulamentadora. A onde tem como adicionar
                o certificado das Normas Regulamentadora e saber quando esta perto de vencer.
              </p>
              <h2>Demonstração: <a href='https://sonda-engenharia-nr.vercel.app/'>https://sonda-engenharia-nr.vercel.app/</a></h2>
              <h2>GitHub: <a href='https://github.com/mdsreq-fga-unb/2023.1-NRControl'>https://github.com/mdsreq-fga-unb/2023.1-NRControl</a></h2>
              <Icones>
                <img src={icheckbox}></img>
                <a>JavaScript</a>
              </Icones>
